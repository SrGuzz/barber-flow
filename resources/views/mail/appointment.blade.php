...
<body>
    <div class="email-wrapper">
        ...
        <div class="content">
            <h2>Olá, {{ $appointments[0]->user->name }} 👋</h2>
            <p>Seu agendamento foi <strong>concluido com sucesso</strong>! Aqui estão os detalhes:</p>
            ...
            @foreach ($appointments as $index => $appointment)
                ...
                <div class="service-box">
                    <h3>💇‍♂️ Serviço {{ $numero }}: {{ $appointment->service->name }}</h3>
